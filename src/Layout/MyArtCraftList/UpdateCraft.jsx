...
const UpdateCraft = () => {
  ...
  const handleUpdate = e => {
    ...
    // send backend
    fetch(
      `https://assignment-10-server-nine-omega.vercel.app/craftItem/${_id}`,
      {
        method: 'PUT',
        headers: {
  ...
  return (
    <div>
      <Fade direction="up" duration={400}>
        <h2 className="text-3xl font-display font-bold text-center text-rose-500 mt-5">
          Update Craft Item
        </h2>
      </Fade>
      <div className="my-7 mx-12 border-4 py-4 space-y-4 px-12 ">
        <Fade>
