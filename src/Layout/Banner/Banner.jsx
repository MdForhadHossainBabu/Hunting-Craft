      ...
      <div>
        ...
        "
                  ...
                  <div className="my-32">
                    <img
                      className="w-full h-full"
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwROY2oBOxYPPVYg6Um-EN60nQT7tpV_sT4Q&s"
                      alt=""
                    />
                  </div>
                </div>
        ...
        "
                  ...
                  <div className="my-32">
                    <img
                      className="w-full h-full"
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRowUmOACtXrlXO03_-Adp45vYEolKkUBOAgg&s"
                      alt=""
                    />
                  </div>
                </div>
        ...
        "
                  ...
                  <div className="my-32">
                    <img
                      className="w-full h-full"
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWNGfSGg1vy-s-iyX46owGFkUIszNooT2hzg&s"
                      alt=""
                    />
                  </div>
                </div>
