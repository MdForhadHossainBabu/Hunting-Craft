 ...
 return (
   <div>
     ...
     <div className="flex flex-col items-center justify-center font-display">
       <h2 className="text-4xl font-bold text-rose-500 mt-12">Register Now</h2>
       <form
         onSubmit={handleSign}
         className="flex flex-col gap-5 md:w-1/2 w-full lg:w-1/2 justify-center my-12 border-4 px-4 py-4 space-y-3"
       >
         ...
         <div className="flex gap-2">
           <input type="checkbox" name="showPassword" id="" /> <p>Show Password</p>
         </div>
         <input
